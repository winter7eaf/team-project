...
public class UserService {
    ...
    public UserService(
        ...
        CharityUserRepository charityUserRepository,
    ...
    public User registerUser(
        ...
        if (charityCheck) {
            authorityRepository.findById(AuthoritiesConstants.CHARITY).ifPresent(authorities::add);
        ...
        if (charityCheck) {
            // Create and save the CharityUser entity
            CharityUser newCharityuser = new CharityUser();
            newCharityuser.setUser(newUser);
            newCharityuser.setId(newUser.getId());

            newCharityuser.setCharityName(charityName);
            newCharityuser.setDescription(description);
            newCharityuser.setLogoURL(logoURL);
            newCharityuser.setWebsite(website);

            charityUserRepository.save(newCharityuser);
            log.debug("Created Information for CharityUser: {}", newCharityuser);
        }
        ...
        userRepository
            ...
            .ifPresent(user -> {
                ...
                charityUserRepository
                    .findById(userId)
                    .ifPresent(charityUser -> {
                        charityUserRepository.delete(charityUser);
                    });
