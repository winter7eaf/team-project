...
describe('UserProfile Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    ...
    it('Should call Tag query and add missing value', () => {
      const userProfile: IUserProfile = { id: 456 };
      const lookingfors: ITag[] = [{ id: 50489 }];
      userProfile.lookingfors = lookingfors;

      const tagCollection: ITag[] = [{ id: 83043 }];
      jest.spyOn(tagService, 'query').mockReturnValue(of(new HttpResponse({ body: tagCollection })));
      const additionalTags = [...lookingfors];
    ...
    it('Should update editForm', () => {
      ...
      userProfile.user = user;
      const lookingfor: ITag = { id: 57780 };
      userProfile.lookingfors = [lookingfor];

      activatedRoute.data = of({ userProfile });
      comp.ngOnInit();

      expect(comp.usersSharedCollection).toContain(user);
      expect(comp.tagsSharedCollection).toContain(lookingfor);
