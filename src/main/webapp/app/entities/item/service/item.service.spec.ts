...
import { ItemService, RestItem } from './item.service';

const requireRestSample: RestItem = {
  ...sampleWithRequiredData,
  uploadTime: sampleWithRequiredData.uploadTime?.toJSON(),
  givenTime: sampleWithRequiredData.givenTime?.toJSON(),
};
