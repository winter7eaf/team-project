...
describe('UserProfile e2e test', () => {
  ...
  it('should load details UserProfile page', function () {
  ...
  it('should load edit UserProfile page', function () {
    cy.visit(userProfilePageUrl);
    cy.wait('@entitiesRequest').then(({ response }) => {
      if (response.body.length === 0) {
        this.skip();
  ...
  it.skip('should create an instance of UserProfile', () => {
    ...
    cy.get(`[data-cy="postcode"]`).type('DH4X 5YE').should('have.value', 'DH4X 5YE');
  ...
  it.skip('should delete last instance of UserProfile', function () {
    cy.visit(userProfilePageUrl);
    cy.wait('@entitiesRequest').then(({ response }) => {
      if (response.body.length > 0) {
