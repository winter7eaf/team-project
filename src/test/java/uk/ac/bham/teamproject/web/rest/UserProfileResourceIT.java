...
class UserProfileResourceIT {
    ...
    private static final String UPDATED_POSTCODE = "R89UA";
    ...
    public static UserProfile createEntity(EntityManager em) {
        UserProfile userProfile = new UserProfile().description(DEFAULT_DESCRIPTION).postcode(DEFAULT_POSTCODE);
        // Add required entity
    ...
    public static UserProfile createUpdatedEntity(EntityManager em) {
        UserProfile userProfile = new UserProfile().description(UPDATED_DESCRIPTION).postcode(UPDATED_POSTCODE);
        // Add required entity
        User user = UserResourceIT.createEntity(em);
        em.persist(user);
        em.flush();
    ...
    void putExistingUserProfile() throws Exception {
        ...
        updatedUserProfile.description(UPDATED_DESCRIPTION).postcode(UPDATED_POSTCODE);
    ...
    void partialUpdateUserProfileWithPatch() throws Exception {
        ...
        partialUpdatedUserProfile.description(UPDATED_DESCRIPTION);
    ...
    void fullUpdateUserProfileWithPatch() throws Exception {
        ...
        partialUpdatedUserProfile.description(UPDATED_DESCRIPTION).postcode(UPDATED_POSTCODE);
